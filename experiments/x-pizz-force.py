...
PARAMS = {
    'cello-c-pizz-short': {'inst_type': 2, 'st': 0,
        'fbmin': 2.0, 'fbmax': 15.0, 'fbi': 9.0,
        'prev_fmi': 6.0, 'prev_dyn': 0.0,
        'pizzdur': 0.250,
        'K_main': 0.0,
        },
    'cello-c-pizz-medium': {'inst_type': 2, 'st': 0,
        'fbmin': 2.0, 'fbmax': 15.0, 'fbi': 9.0,
        'prev_fmi': 6.0, 'prev_dyn': 0.0,
        'pizzdur': 0.50,
        'K_main': 0.0,
        },
    'cello-c-pizz-long': {'inst_type': 2, 'st': 0,
        'fbmin': 2.0, 'fbmax': 15.0, 'fbi': 9.0,
        'prev_fmi': 6.0, 'prev_dyn': 0.0,
        'pizzdur': 2.0,
        'K_main': 0.0,
        },
    'cello-c-pizz-short-adjust': {'inst_type': 2, 'st': 0,
        'fbmin': 2.0, 'fbmax': 15.0, 'fbi': 9.0,
        'prev_fmi': 6.0, 'prev_dyn': 0.0,
        'pizzdur': 0.250,
        'K_main': 0.1,
        },
    'cello-c-pizz-medium-adjust': {'inst_type': 2, 'st': 0,
        'fbmin': 2.0, 'fbmax': 15.0, 'fbi': 9.0,
        'prev_fmi': 6.0, 'prev_dyn': 0.0,
        'pizzdur': 0.50,
        'K_main': 0.1,
        },
    'cello-c-pizz-long-adjust': {'inst_type': 2, 'st': 0,
        'fbmin': 2.0, 'fbmax': 15.0, 'fbi': 9.0,
        'prev_fmi': 6.0, 'prev_dyn': 0.0,
        'pizzdur': 2.0,
        'K_main': 0.1,
...
def main():
    ...
    process("cello-c-pizz-short")
    process("cello-c-pizz-medium")
    process("cello-c-pizz-long")

    process("cello-c-pizz-short-adjust")
    process("cello-c-pizz-medium-adjust")
    process("cello-c-pizz-long-adjust")
