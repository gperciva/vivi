...
violinOne = \new Voice {
	...
	\relative g'' {
		...
		\repeat tremolo 8 d16 \deprecatedcresc \repeat tremolo 4 e \repeat tremolo 4 fis
		\repeat tremolo 4 g \repeat tremolo 4 a \repeat tremolo 4 b \repeat tremolo 4 cis
		\deprecatedendcresc d4.\f a8 cis8.( a16) cis8.( a16) %% \forte
...
\book {
	...
	\paper {
		#(layout-set-absolute-staff-size (* 6 mm))
		ragged-bottom = ##f
